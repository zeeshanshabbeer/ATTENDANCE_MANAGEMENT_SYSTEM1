...
router.post("/Request_Attendance",authController.protect,authController.restrict("Admin","Teacher"), attendenceController.requestAttendance)
...
//attendance report
router.get("/Student_Attendance_Report",authController.protect, authController.restrict("Admin","Teacher"),attendenceController.attendanceSheet)
